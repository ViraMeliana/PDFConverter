...
public class PptxToPdf extends Converter{

	

	public PptxToPdf(InputStream inStream, OutputStream outStream, boolean showMessages, boolean closeStreamsWhenComplete) {
	...
	public void convert() throws Exception {
	    ...
	    double zoom = 2; // magnify it by 2 as typical slides are low res
            //mapping coordinate and transform
